...
$(function(){
	$(".lineBtn").on('click',function(){
		...
		$(location).attr('href', '/board/readBoard?board_no='+board_no);
	})

// 	function changePage(kind_no, kind_name, page, pageSize){
// 		$.ajax({
// 			url : "/board/boardlist",
// 			data : {kind_no : kind_no,
// 				    kind_name : kind_name,
// 				    page : page, 
// 				    pageSize : pageSize},
// 			method : "GET", 
...
<div id="listCont" class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	<div class="row">
